...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s78">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n6">
        ...
        <node id="n40">
            <attr name="layout">
                <string>564 127 51 18</string>
            </attr>
        </node>
        <node id="n65">
            <attr name="layout">
                <string>442 130 30 18</string>
            </attr>
        </node>
        <node id="n66">
            <attr name="layout">
                <string>614 53 30 18</string>
            </attr>
        </node>
        <node id="n106">
            <attr name="layout">
                <string>322 112 71 54</string>
            </attr>
        </node>
        <node id="n107">
            <attr name="layout">
                <string>713 8 71 54</string>
            </attr>
        </node>
        <node id="n168">
            <attr name="layout">
                <string>532 223 51 18</string>
            </attr>
        </node>
        <edge from="n6" to="n6">
            <attr name="label">
        ...
        <edge from="n168" to="n65">
            <attr name="label">
                <string>to</string>
            </attr>
        </edge>
        <edge from="n168" to="n66">
            <attr name="label">
                <string>to</string>
            </attr>
        </edge>
