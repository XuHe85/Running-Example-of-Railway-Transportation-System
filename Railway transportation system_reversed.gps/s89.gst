...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s89">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n6">
        ...
        <node id="n24">
            <attr name="layout">
                <string>584 223 30 18</string>
            </attr>
        </node>
        <node id="n41">
            <attr name="layout">
                <string>584 91 30 18</string>
            </attr>
        </node>
        <node id="n76">
            <attr name="layout">
                <string>499 128 30 18</string>
            </attr>
        </node>
        <node id="n115">
            <attr name="layout">
                <string>363 109 71 54</string>
            </attr>
        </node>
        <node id="n181">
            <attr name="layout">
                <string>663 254 51 18</string>
            </attr>
        </node>
        <edge from="n6" to="n6">
            <attr name="label">
