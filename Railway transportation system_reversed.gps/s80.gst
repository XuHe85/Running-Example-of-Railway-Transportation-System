...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s80">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n6">
        ...
        <node id="n24">
            <attr name="layout">
                <string>511 224 30 18</string>
            </attr>
        </node>
        <node id="n40">
            <attr name="layout">
                <string>618 127 51 18</string>
            </attr>
        </node>
        <node id="n65">
            <attr name="layout">
                <string>739 128 30 18</string>
            </attr>
        </node>
        <node id="n66">
            <attr name="layout">
                <string>539 100 30 18</string>
            </attr>
        </node>
        <node id="n106">
            <attr name="layout">
                <string>832 62 71 54</string>
            </attr>
        </node>
        <node id="n107">
            <attr name="layout">
                <string>455 8 71 54</string>
            </attr>
        </node>
        <node id="n171">
            <attr name="layout">
                <string>663 242 51 18</string>
            </attr>
        </node>
        <edge from="n6" to="n6">
            <attr name="label">
        ...
        <edge from="n171" to="n65">
            <attr name="label">
                <string>to</string>
            </attr>
        </edge>
        <edge from="n171" to="n66">
            <attr name="label">
                <string>to</string>
            </attr>
        </edge>
