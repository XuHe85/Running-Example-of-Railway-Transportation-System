...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s87">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n6">
        ...
        <node id="n24">
            <attr name="layout">
                <string>714 224 30 18</string>
            </attr>
        </node>
        <node id="n41">
            <attr name="layout">
                <string>677 105 30 18</string>
            </attr>
        </node>
        <node id="n76">
            <attr name="layout">
                <string>538 108 30 18</string>
            </attr>
        </node>
        <node id="n115">
            <attr name="layout">
                <string>455 11 71 54</string>
            </attr>
        </node>
        <node id="n179">
            <attr name="layout">
                <string>567 229 51 18</string>
            </attr>
        </node>
        <edge from="n6" to="n6">
            <attr name="label">
