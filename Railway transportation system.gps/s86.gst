...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s86">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n6">
        ...
        <node id="n24">
            <attr name="layout">
                <string>501 223 30 18</string>
            </attr>
        </node>
        <node id="n41">
            <attr name="layout">
                <string>568 120 30 18</string>
            </attr>
        </node>
        <node id="n76">
            <attr name="layout">
                <string>701 128 30 18</string>
            </attr>
        </node>
        <node id="n115">
            <attr name="layout">
                <string>791 59 71 54</string>
            </attr>
        </node>
        <node id="n178">
            <attr name="layout">
                <string>702 276 30 18</string>
            </attr>
        </node>
        <edge from="n6" to="n6">
            <attr name="label">
