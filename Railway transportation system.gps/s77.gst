...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s77">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n6">
        ...
        <node id="n24">
            <attr name="layout">
                <string>477 226 30 18</string>
            </attr>
        </node>
        <node id="n40">
            <attr name="layout">
                <string>466 118 51 18</string>
            </attr>
        </node>
        <node id="n65">
            <attr name="layout">
                <string>619 120 30 18</string>
            </attr>
        </node>
        <node id="n66">
            <attr name="layout">
                <string>313 95 30 18</string>
            </attr>
        </node>
        <node id="n106">
            <attr name="layout">
                <string>697 38 71 54</string>
            </attr>
        </node>
        <node id="n107">
            <attr name="layout">
                <string>213 172 71 54</string>
            </attr>
        </node>
        <node id="n166">
            <attr name="layout">
                <string>677 256 30 18</string>
            </attr>
        </node>
        <node id="n167">
            <attr name="layout">
                <string>277 8 30 18</string>
            </attr>
        </node>
        <edge from="n6" to="n6">
            <attr name="label">
