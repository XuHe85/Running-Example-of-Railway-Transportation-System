...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s85">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n6">
        ...
        <node id="n24">
            <attr name="layout">
                <string>506 222 30 18</string>
            </attr>
        </node>
        <node id="n41">
            <attr name="layout">
                <string>377 156 30 18</string>
            </attr>
        </node>
        <node id="n76">
            <attr name="layout">
                <string>260 226 30 18</string>
            </attr>
        </node>
        <node id="n115">
            <attr name="layout">
                <string>151 176 71 54</string>
            </attr>
        </node>
        <node id="n177">
            <attr name="layout">
                <string>296 394 51 18</string>
            </attr>
        </node>
        <edge from="n6" to="n6">
            <attr name="label">
