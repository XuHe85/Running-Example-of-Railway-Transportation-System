...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s79">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n6">
        ...
        <node id="n24">
            <attr name="layout">
                <string>377 273 30 18</string>
            </attr>
        </node>
        <node id="n40">
            <attr name="layout">
                <string>259 460 51 18</string>
            </attr>
        </node>
        <node id="n65">
            <attr name="layout">
                <string>322 625 30 18</string>
            </attr>
        </node>
        <node id="n66">
            <attr name="layout">
                <string>125 425 30 18</string>
            </attr>
        </node>
        <node id="n106">
            <attr name="layout">
                <string>274 717 71 54</string>
            </attr>
        </node>
        <node id="n107">
            <attr name="layout">
                <string>49 517 71 54</string>
            </attr>
        </node>
        <node id="n169">
            <attr name="layout">
                <string>495 625 30 18</string>
            </attr>
        </node>
        <node id="n170">
            <attr name="layout">
                <string>69 335 30 18</string>
            </attr>
        </node>
        <edge from="n6" to="n6">
            <attr name="label">
