...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s88">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n6">
        ...
        <node id="n24">
            <attr name="layout">
                <string>490 223 30 18</string>
            </attr>
        </node>
        <node id="n41">
            <attr name="layout">
                <string>556 120 30 18</string>
            </attr>
        </node>
        <node id="n76">
            <attr name="layout">
                <string>690 128 30 18</string>
            </attr>
        </node>
        <node id="n115">
            <attr name="layout">
                <string>778 56 71 54</string>
            </attr>
        </node>
        <node id="n180">
            <attr name="layout">
                <string>691 274 30 18</string>
            </attr>
        </node>
        <edge from="n6" to="n6">
            <attr name="label">
