...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s81">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n6">
        ...
        <node id="n24">
            <attr name="layout">
                <string>483 226 30 18</string>
            </attr>
        </node>
        <node id="n40">
            <attr name="layout">
                <string>472 125 51 18</string>
            </attr>
        </node>
        <node id="n65">
            <attr name="layout">
                <string>632 128 30 18</string>
            </attr>
        </node>
        <node id="n66">
            <attr name="layout">
                <string>304 110 30 18</string>
            </attr>
        </node>
        <node id="n106">
            <attr name="layout">
                <string>717 60 71 54</string>
            </attr>
        </node>
        <node id="n107">
            <attr name="layout">
                <string>282 8 71 54</string>
            </attr>
        </node>
        <node id="n172">
            <attr name="layout">
                <string>683 278 30 18</string>
            </attr>
        </node>
        <node id="n173">
            <attr name="layout">
                <string>196 190 30 18</string>
            </attr>
        </node>
        <edge from="n6" to="n6">
            <attr name="label">
